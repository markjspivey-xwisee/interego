...
| --- | --- | --- | --- | --- |
| `interego-foxxi` | Foxxi content intelligence, learner surface | 42 | `https://foxxi-bridge.interego.xwisee.com` | [SKILL.md](foxxi/SKILL.md), [reference.md](foxxi/reference.md) |

...
| --- | --- | --- | --- | --- |
| `interego-foxxi` | Foxxi content intelligence, learner surface | 47 | `https://foxxi-bridge.interego.xwisee.com` | [SKILL.md](foxxi/SKILL.md), [reference.md](foxxi/reference.md) |
| `interego-foxxi-admin` | Foxxi content intelligence, administration | 74 | `https://foxxi-bridge.interego.xwisee.com` | [SKILL.md](foxxi-admin/SKILL.md), [reference.md](foxxi-admin/reference.md) |

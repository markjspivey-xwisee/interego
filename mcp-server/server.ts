  ...
  tools: ([
    ...
    // ═══════════════════════════════════════════════════════════
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          confidence: { type: 'number', description: 'Epistemic confidence 0.0-1.0 (default 0.85 — paired with the Asserted default).' },
          modal_status: { type: 'string', enum: ['Asserted', 'Hypothetical', 'Counterfactual'], description: 'Semiotic modal status (default: Asserted — an explicit publish is a committed claim). Pass Hypothetical for inferred-but-uncommitted observations; Counterfactual for explicit "not true" or retraction.' },
    ...
    },
    {
      ...
      inputSchema: {
        type: 'object' as const,
        properties: {
          resource: { type: 'string', description: 'WebFinger resource (e.g. "acct:markj@identity.interego.xwisee.com" or a WebID URL)' },
        },
        required: ['resource'],
      },
      outputSchema: GENERIC_OUTPUT_SCHEMA,

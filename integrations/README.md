...
| [`hermes-memory/`](hermes-memory/) | Hermes Agent | Hermes `MemoryProvider` plugin ↔ Interego pod-rooted typed memory; same `ieh:AgentMemory` shape + 3-tool HATEOAS surface as the OpenClaw provider |

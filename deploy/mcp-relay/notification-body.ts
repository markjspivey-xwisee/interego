 ...
 *
 *  2. ★ IT PARSED THE WHOLE 214,267-CHARACTER ONTOLOGY ON THE EVENT LOOP, PER NOTIFICATION.
 ...
 *     (Characters, not bytes: 214,267 characters of this ontology is 221,598 bytes,
 ...
 *     not reduce maintenance, it turns the suite red. Editing the ontology is meant to
 *     go red here and name the sites to update.)
 *
 ...
 * 214,267 characters of Turtle as shipped and the engine reparses the shapes graph on every
 ...
 * still preserves this shape's verdicts. Read the 214,267-character ontology, isolate, run all

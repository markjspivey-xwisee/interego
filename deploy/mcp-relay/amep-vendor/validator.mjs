// VENDORED from https://github.com/markjspivey-xwisee/affordant-memory-protocol
// tools/conformance/validator.mjs @ 0.1 (MIT, same author). VERBATIM — do not edit.
// Rationale: the relay validates AMEP exchanges with the SPEC's OWN reference
// validator, so relay conformance cannot drift from the spec. Update by re-copying
// from the upstream repo, never by hand-editing here.
...
export const PROFILE_IRI = 'https://markjspivey-xwisee.github.io/affordant-memory-protocol/0.1';

...
AGP owns the performance consulting and management model. FOXXI composes that model for content, assessments and standards delivery. The same methods apply to humans, agents and mixed teams; they do not add domain-specific tools to the neutral Interego core.

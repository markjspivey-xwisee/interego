/**
 * AGP-owned performance routes, mounted by FOXXI for HTTP compatibility.
 *
...
} from '../../foxxi-content-intelligence/src/emergent-content.js';
import {
...
} from '../../foxxi-content-intelligence/src/outcome-descriptor-publisher.js';
import { FederationOutcomeLoader, parseFederationPods } from '../../foxxi-content-intelligence/src/federation-outcome-loader.js';
import { bridgeAuthor, signAsBridge, withPublishLock } from '../../foxxi-content-intelligence/src/bridge-signer.js';
import { affordancesManifestTurtle, type Affordance } from '../../_shared/affordance-mcp/index.js';
import { FOXXI_NS } from '../../foxxi-content-intelligence/src/foxxi-vocab.js';
import { isSafeIri } from '../../foxxi-content-intelligence/src/turtle-escape.js';
import { sendServerError } from '../../foxxi-content-intelligence/src/http-errors.js';
import type {
  IRI,
} from '@interego/core';

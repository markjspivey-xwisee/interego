...
// The xAPI projection composes Foxxi's standards layer (the single domain-agnostic
// `performed` verb + performance context-extension keys) — the correct L2->L1
// direction. This is the only cross-vertical import in the engine spine; everything

 ...
 * extraction; existing Foxxi imports of `./performance-calibration.js` resolve unchanged through this
 * shim, so Foxxi behaves identically. Phase 2b migrates Foxxi's /performance
 * surface to the agp bridge and removes these shims.
 */
export * from '../../agentic-performance-practice/src/performance-calibration.js';

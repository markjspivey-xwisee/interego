 ...
 * `cg:constructedFrom` triples pointing at the substrate primitives it
...
const LER_TERMS: readonly SemTerm[] = [
  ...
  // ── The Enterprise Learner Record — composed, not a content class ──
  {
    ...
    subClassOf: ['cg:ComposedDescriptor', 'prov:Collection'],
    constructedFrom: ['ler:RecordEntry', 'cg:ProvenanceFacet', 'cg:AgentFacet'],
  ...
  },
  {
    ...
    constructedFrom: ['amta:Attestation', 'cg:ProvenanceFacet'],
  },
  {
    ...
    subClassOf: ['cg:ComposedDescriptor'],
    constructedFrom: ['ler:EnterpriseLearnerRecord', 'cg:AgentFacet'],
  },
  {
    ...
    constructedFrom: ['ler:EnterpriseLearnerRecord', 'cg:CompositionOperator'],
  ...
  // ── Attestations + evidence (composed over the attestation primitive)
  {
    ...
    subClassOf: ['amta:Attestation'],
    constructedFrom: ['amta:Attestation', 'cg:assertingAgent', 'cg:modalStatus'],
  ...
  },
  {
    ...
    constructedFrom: ['prov:Entity', 'cg:provenanceChain'],
  },
  {
  ...
  },
  {
    ...
    constructedFrom: ['vc:VerifiableCredential', 'cg:verifiableCredential'],
  ...
  // ── Identity binding (a composition over sameAs/provenance) ────────
  {
    ...
    constructedFrom: ['cg:AgentFacet', 'cg:provenanceChain'],
  },
  ...
  // ── Roles (a generic Agent in a role — not a subclass of Person) ───
  {
    ...
    constructedFrom: ['prov:Agent', 'cg:agentRole'],
  },
  {
...
const TLA_TERMS: readonly SemTerm[] = [
  ...
  },
  {
    ...
    subClassOf: ['amta:Attestation'],
    constructedFrom: ['amta:Attestation', 'amta:CompetenceRating', 'cg:modalStatus'],
  ...
  // ── Learning-activity-metadata pillar ──────────────────────────────
  {
    ...
    subClassOf: ['cg:ContextDescriptor'],
    constructedFrom: ['cg:ContextDescriptor', 'cg:SemioticFacet'],
  },
  {
    ...
    constructedFrom: ['tla:LearningActivityMetadata', 'cg:CompositionOperator'],
  },
  {
    ...
    subClassOf: ['cg:ComposedDescriptor'],
    constructedFrom: ['tla:LearningActivityMetadata', 'cg:FederationFacet'],
  },
  ...
  },
  {
    ...
    subClassOf: ['cg:ComposedDescriptor'],
    constructedFrom: ['hela:Statement', 'cg:AgentFacet'],
  ...
  },
  {
    ...
    source: 'ADL TLA federated LRS layer',
    constructedFrom: ['hela:Statement', 'hela:Verb', 'cg:CompositionOperator'],
  },
  {
    ...
    source: 'ADL TLA federated LRS layer',
    constructedFrom: ['hela:Statement', 'cg:TrustFacet', 'cg:CompositionOperator'],
  },
  ...
  // ── Learner state — VIEWS over the MOM statement stream ────────────
  {
    ...
    constructedFrom: ['hela:Statement', 'cg:TemporalFacet', 'cg:supersedes'],
  },
  {
    ...
    constructedFrom: ['hela:Statement', 'cg:TemporalFacet'],
  },
  {
  ...
  // ── TLA services (roles / components) ──────────────────────────────
  {
    ...
    subClassOf: ['cg:Affordance'],
    constructedFrom: ['cg:Affordance'],
  },
  {
...
function ttlRef(ref: string): string {
  ...
  return ref; // already prefixed (cg:, prov:, ler:, tla:, skos:, vc:, amta:, hela:)
}
...
function renderTermTurtle(t: SemTerm): string {
  ...
  for (const cf of t.constructedFrom ?? []) lines.push(`    cg:constructedFrom ${ttlRef(cf)} ;`);
...
const JSONLD_CONTEXT: Record<string, unknown> = {
  ...
  cg: PREFIXES.cg, prov: PREFIXES.prov, vc: PREFIXES.vc, amta: PREFIXES.amta,
  ...
  constructedFrom: { '@id': 'cg:constructedFrom', '@type': '@id' },
...
export function renderSemOntologyJsonLd(family: 'ler' | 'tla'): Record<string, unknown> {
  ...
  return {
    ...
    label: family === 'ler'
      ? 'IEEE Learning & Employment Records — emergent composable ontology'
      : 'ADL Total Learning Architecture — emergent composable ontology',
    comment: 'Modelled as compositions over the Interego substrate — minted terms are genuinely new; composed / view / role terms carry cg:constructedFrom triples naming the primitives they emerge from.',

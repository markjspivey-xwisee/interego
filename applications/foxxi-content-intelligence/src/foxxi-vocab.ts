...
export const FOXXI_TERMS: readonly FoxxiTerm[] = [
  ...
  { name: 'AgentCapability', kind: 'Type', label: 'Agent Capability', definition: 'A capability one agent teaches another (the A2A directionality): a playbook (a Course with an agent audience) plus the affordances it confers, and a behaviour signature. A learner agent acquires it as context; transfer is verified by reading the learner’s own trajectories. Hypothetical until a verified transfer promotes it to Asserted.' },

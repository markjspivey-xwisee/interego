 ...
 * extraction; existing Foxxi imports of `./agent-disposition.js` resolve unchanged through this
 * shim, so Foxxi behaves identically. Phase 2b migrates Foxxi's /performance
 * surface to the agp bridge and removes these shims.
 */
export * from '../../agentic-performance-practice/src/agent-disposition.js';

...
| Names & Roles Provisioning Service (NRPS 2.0) | **Compliant** | `GET /lti/nrps/members` — the tenant roster as a membership container (operator-only), or `?members_url=` read from a platform with a Tool-signed token |

 ...
 * bridge, and the switches the workflow passes; prints every condition and the decision;
 ...
 * a green job that says so, not a red one. src/auto-merge.ts is the policy.
 */

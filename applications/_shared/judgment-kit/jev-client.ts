/**
 * TypeSafe System One client: the one place a vertical talks to Jev. Shared by the judgment kit so every vertical judges, and tests its judgments, the same way (jev-harness first, then Foxxi).
 *

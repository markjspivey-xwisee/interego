 ...
 */
export type ChapterId = 'signin' | 'author' | 'discover' | 'learn' | 'claim' | 'verify' | 'forgery';
...
export const CHAPTER_ORDER: readonly ChapterId[] = ['signin', 'author', 'discover', 'learn', 'claim', 'verify', 'forgery'];

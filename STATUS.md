...
- **`npx vitest run`** — **1409/1409 passing**, 29 skipped (network / external dependencies).
...
| Auditing the aggregate-privacy contract | [`applications/_shared/aggregate-privacy/index.ts`](applications/_shared/aggregate-privacy/index.ts) + the 77 contract tests in [`applications/_shared/tests/aggregate-privacy.test.ts`](applications/_shared/tests/aggregate-privacy.test.ts) |
